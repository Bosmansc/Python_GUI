...
imagepath1 = r'C:\Users\bosmansc\Pictures\Anfield.jpg' #include the path for the image (use 'r' before the path string to address any special character such as '\'. Also, make sure to include the image type - here it is jpg)
